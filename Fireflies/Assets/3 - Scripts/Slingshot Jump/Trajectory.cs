...
public class Trajectory : MonoBehaviour
{
    ...
    public void SimulateArc()
    {
        ...
        float launchSpeed = playerSC.impulseVector.magnitude * Setup.Instance.PlayerValue.rImpulseForce * Setup.Instance.PlayerValue.rImpulseForce * lerpSpeed * Player.GetComponent<Rigidbody2D>().mass * massMultiplier;
